...
Foundation -- 6-Month Live Project-Based Internship with Certificate**.
The project predicts a student's chance of admission to a graduate
program using academic and profile-related features.
...
├── README.md
└── YBI_Graduate_Admission_Prediction.ipynb
```

## How to Run the Project

1.  Open `YBI_Graduate_Admission_Prediction.ipynb` in Google Colab or
    Jupyter Notebook.
2.  Run all cells in order.
3.  The dataset loads directly from the configured dataset URL.
4.  Review the analysis, model comparison, visualizations, and
    prediction results.
...
## Internship Details
  ...
  Program                   6-Month Live Project-Based Internship with Certificate
  Mode                      Fully Remote / Virtual
  Duration                  6 Months
  Enrollment Date           January 8, 2026
  Expiry Date               July 22, 2026
  Project Completion Year   2026

### Internship Curriculum

The internship curriculum covered:
...
### Internship Project Process

**Training Phase → Project Allotment → Project Submission and Evaluation
...
Live Project-Based Internship with Certificate**.
